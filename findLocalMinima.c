// Matlab call:
//     idxs = findLocalMinima(Y)
//     idxs = findLocalMinima(Y, w)
//     idxs = findLocalMinima(Y, w, k)
//     idxs = findLocalMinima(Y, w, k, 'first')
//     idxs = findLocalMinima(Y, w, k, 'first', edgeOK)
//     [idxs, vals] = findLocalMinima(...)
//
