function dendParams = calcDendrogram(Z,varargin)
%DENDROGRAM Generate dendraogram plot.
...
dendParams = struct('X', X, 'Y', Y, 'Z', Z, 'T', T, 'color', color, 'horz', horz, 'orientation', orientation, 'label', {label});
